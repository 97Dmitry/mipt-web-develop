...
- BFF сохраняет понятные коды ошибок доменных сервисов
- формат ошибок для фронтенда единый: `code`, `message`, `details`
...
- `login`: `admin`
- `password_hash`: PBKDF2-SHA256 хэш пароля `Admin123!`
